...
const ChartRenderer = props => {
  ...
  const handleAddFilterHandler = useCallback(
    (col, vals, merge = true, refresh = true) => {
  ...
  const handleOnContextMenuHandler = useCallback(
    (offsetX, offsetY, filters) => {
  ...
  const handleLegendStateChangedHandler = useCallback(
    legendState => {
  ...
  const onContextMenuFallbackHandler = useCallback(
    event => {
      if (!inContextMenu) {
