...
const AdhocMetricEditPopover = props => {
  ...
  useEffect(() => {
    if (
      prevState.adhocMetric?.sqlExpression !== adhocMetric?.sqlExpression ||
  ...
  const onSavedMetricChangeHandler = useCallback(
    savedMetricName => {
  ...
  const onDragDownHandler = useCallback(
    e => {
  ...
  const renderMetricOptionHandler = useCallback(
    savedMetric => {
